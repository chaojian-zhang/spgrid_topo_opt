...
n = 300
opt = TopoOpt(res=(n, n, n), version=version, volume_fraction=volume_fraction, max_iterations=50,
...
tex = tc.Texture(
  ...
  scale=(s, s, s),
  adaptive=False,
  filename='/home/holycow/chi/taichi/projects/spgrid_topo_opt/data/beak.obj')
...
# try plane force
opt.general_action(action='add_mesh_normal_force', mesh_fn='/home/holycow/chi/taichi/projects/spgrid_topo_opt/data/beak.obj', magnitude=-1, center=(0.5, 0, 0), falloff=1000, maximum_distance=0.015, override=(0, 0, 0))
